...
public class BD {
    ...
    private static final String SQL_DROP_CREATE="DROP TABLE IF EXISTS PACIENTES; CREATE TABLE PACIENTES " +
            ...
            "CEDULA VARCHAR(10) NOT NULL, FECHA_INGRESO DATE NOT NULL, DOMICILIO_ID INT NOT NULL); " +
            ...
            "DROP TABLE IF EXISTS ODONTOLOGOS; CREATE TABLE ODONTOLOGOS (ID INT AUTO_INCREMENT PRIMARY KEY, MATRICULA INT NOT NULL, NOMBRE VARCHAR(30) NOT NULL, APELLIDO VARCHAR(30) NOT NULL);";
